...
public class Exercise2 extends BaseTest {
    ...
    public void exercise2() {
        ...
        difElementsPage.getHeader().login(getProperties.getUsernameProp(), getProperties.getPasswordProp());
        ...
        softly.assertThat(difElementsPage.getHeader().getUserNameText())
                .as("Incorrect user name")
                .isEqualTo(getProperties.getUsernameTextProp());

        //5. Open through the header menu Service -> Different Elements Page
        difElementsPage.getHeader().getServiceButton().click();
        difElementsPage.getHeader().getDifElements().click();
